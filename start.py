...
intents = [Intent(intent_type='', threat='', host=[], duration='')]
...
workflows = [Workflow(command='', intent_type='', threat='', host='', action='', duration='', intent_id='')]
...
whatif_sends = [Whatif_send(command='', intent_type='', threat='', host=[], action='', duration='')]
...
whatif_receives = [Whatif_receive(command='', intent_type='', threat='', host=[], action='', duration='', what_if_response='')]
...
stored_intents = [Stored_intent(id=0, intent_type='', threat='', host='', action='', duration='', intent_id='')]
